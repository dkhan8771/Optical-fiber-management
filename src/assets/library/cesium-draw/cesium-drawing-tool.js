class CesiumDrawingTool {
    ...
    constructor(viewer, elementId, iconPath) {
        ...
        this.text = {
            normal: 'Select a tool to draw。',
            point: 'Click the mouse over the map to add a marker，Esc key to exit editing.',
            line: 'Left-click the map to add a segment，Right-click to complete the graphic，Esc key to exit editing.',
            area: 'Left-click on the map to draw the polygon，Right-click to complete the graphic，Esc key to exit editing.',
            deleteOne: 'Click the drawing to delete',
            deleteOneDone: 'The drawing was successfully deleted。',
            deleteAllDone: 'All drawings were successfully deleted。'
        };
    }
    ...
    init() {
        ...
        $('#' + this.elementId).append("<div class='cesium-drawing-tool message'>Select a tool to draw</div>");
        $('#' + this.elementId).append("<div class='cesium-drawing-tool button-container'> \
            <a title='Add tags' class='cesium-drawing-tool button draw-point'><i class='material-icons'>add_location</i></a>\
            <a title='Draw segments' class='cesium-drawing-tool button draw-line'><i class='material-icons'>timeline</i></a>\
            <a title='Draw the area' class='cesium-drawing-tool button draw-area'><i class='material-icons'>texture</i></a>\
            <a title='Clear a drawing' class='cesium-drawing-tool button remove-one'><i class='material-icons'>clear</i></a>\
            <a title='Clear all drawings' class='cesium-drawing-tool button remove-all'><i class='material-icons'>delete_sweep</i></a>\
        </div>");
